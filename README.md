...
# Import Data
All datasets were imported into RStudio and Jupyter Hub for preprocessing and cleaning. Data types were standardized to maintain consistency across tools and ensure smooth integration during analysis. Validation queries and checks were performed in each environment to confirm the accuracy of the imported data. The detailed code for data imports in all three languages can be found in the data_import folder.
